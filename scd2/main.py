...
## Импортируем transactions_01032021.txt
# Чтение из файла
df = pd.read_csv( '/home/de12/yavl/project/transactions_01032021.txt', sep=';', header=0, index_col=None )
...
## Импортируем terminals_01032021.xlsx
# Чтение из файла
df = pd.read_excel( '/home/de12/yavl/project/terminals_01032021.xlsx', sheet_name='terminals', header=0, index_col=None )
# Запись DataFrame в таблицу базы данных
cursor_dwh.executemany(
    """INSERT INTO de12.yavl_stg_terminals( terminal_id, terminal_type, terminal_city, terminal_address, update_dt ) 
    VALUES( %s, %s, %s, %s, to_timestamp('01032021 00:00:00','DDMMYYYY HH24:MI:SS') )""",
    df.values.tolist())
...
## Импортируем passport_blacklist_01032021.xlsx
# Чтение из файла
df = pd.read_excel( '/home/de12/yavl/project/passport_blacklist_01032021.xlsx', sheet_name='blacklist', header=0, index_col=None )
# Запись DataFrame в таблицу базы данных
cursor_dwh.executemany(
...
os.rename('/home/de12/yavl/project/transactions_01032021.txt' , '/home/de12/yavl/project/archive/transactions_01032021.txt.backup')
os.rename('/home/de12/yavl/project/terminals_01032021.xlsx', '/home/de12/yavl/project/archive/terminals_01032021.xlsx.backup')
os.rename('/home/de12/yavl/project/passport_blacklist_01032021.xlsx', '/home/de12/yavl/project/archive/passport_blacklist_01032021.xlsx.backup')
